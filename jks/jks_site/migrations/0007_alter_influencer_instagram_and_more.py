...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('jks_site', '0006_alter_influencer_instagram_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='instagram',
            field=models.CharField(blank=True, default='1M', max_length=100, verbose_name='Статистика инстаграм'),
        ),
        migrations.AlterField(
            model_name='influencer',
        ...
        migrations.AlterField(
            model_name='influencer',
            name='tiktok',
            field=models.CharField(blank=True, default='26M', max_length=100, verbose_name='Статистика tiktok'),
        ),
        migrations.AlterField(
            model_name='influencer',
        ...
        migrations.AlterField(
            model_name='influencer',
            name='youtube',
            field=models.CharField(blank=True, default='3.45K', max_length=100, verbose_name='Статистика youtube'),
        ),
        migrations.AlterField(
            model_name='influencer',
